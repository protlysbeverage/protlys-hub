...
function StepProgress({step}){return <div style={{marginBottom:12}}><div style={{fontSize:10,fontWeight:800,letterSpacing:'.06em',color:'var(--ink-45)',marginBottom:6}}>Step {step} of 4</div><div style={{height:4,background:'#232b25',borderRadius:999,overflow:'hidden'}}><div style={{height:'100%',width:`${step*25}%`,background:'#4ADE80',borderRadius:999}}/></div></div>;}
