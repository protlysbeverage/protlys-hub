...
function StepProgress({step}){return <div style={{marginBottom:12}}><div style={{fontSize:12,fontWeight:900,letterSpacing:'.05em',color:'var(--ink-70)',marginBottom:6}}>Step {step} of 4</div><div style={{height:4,background:'var(--ink-20)',borderRadius:999,overflow:'hidden'}}><div style={{height:'100%',width:`${step*25}%`,background:'var(--green)',borderRadius:999}}/></div></div>;}
...
export default function CalculatorClient({ savedTarget }) {
  ...
  const step={fontSize:14,fontWeight:900,letterSpacing:'.05em',color:'var(--ink)'};
